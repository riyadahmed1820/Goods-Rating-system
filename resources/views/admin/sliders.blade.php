                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              @if ($slider->status==1)
                              <button class="btn btn-outline-warning" onclick="window.location ='{{URL::to('/deactivate_slider/'.$slider->id)}}'">Deactivate</button>
                              @else
                              <button class="btn btn-outline-success" onclick="window.location ='{{URL::to('/activate_slider/'.$slider->id)}}'">Active</button>
                              @endif
                            </td>
                        </tr>
