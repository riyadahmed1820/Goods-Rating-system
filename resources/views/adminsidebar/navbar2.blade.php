        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              ...
              <li class="nav-item"><a class="nav-link" href="{{URL::to('/addlocation')}}">Add location</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="{{URL::to('/locations')}}">Locations</a></li>
                ...
                <li class="nav-item"> <a class="nav-link" href="{{URL::to('/complains')}}">Complains</a></li>
              </ul>
            </div>
          </li>
        </ul>
